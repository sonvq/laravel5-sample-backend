...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'corporate-deck' => [
            'create_error' => 'There was a problem creating this corporate deck. Please try again.',
            'delete_error' => 'There was a problem deleting this corporate deck. Please try again.',
            'mark_error' => 'There was a problem updating this corporate deck. Please try again.',
            'not_found' => 'That corporate deck does not exist.',
            'update_error' => 'There was a problem updating this corporate deck. Please try again.',
        ],
        'category' => [
            ...
            'mark_error' => 'There was a problem updating this category. Please try again.',
            'not_found' => 'That category does not exist.',
            'update_error' => 'There was a problem updating this category. Please try again.',
        ],
        'product-catalogue' => [
            'create_error' => 'There was a problem creating this product catalogue. Please try again.',
            'delete_error' => 'There was a problem deleting this product catalogue. Please try again.',
            'mark_error' => 'There was a problem updating this product catalogue. Please try again.',
            'not_found' => 'That product catalogue does not exist.',
            'update_error' => 'There was a problem updating this product catalogue. Please try again.',
        ]
    ],
    ...
    'frontend' => [
        'auth' => [
            ...
            'limit' => [
                'normal_user' => 'You do not have permission to access admin panel'
            ],
