...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Active::pattern('admin/corporate-deck*') }}">
                {{ link_to_route('admin.corporate-deck.index', trans('menus.backend.sidebar.corporate-deck')) }}
            </li>
            
            <li class="{{ Active::pattern('admin/product-catalogue*') }}">
                {{ link_to_route('admin.product-catalogue.index', trans('menus.backend.sidebar.product-catalogue')) }}
            </li>
            
            <li class="{{ Active::pattern('admin/category*') }}">
                {{ link_to_route('admin.category.index', trans('menus.backend.sidebar.settings')) }}
            </li>
