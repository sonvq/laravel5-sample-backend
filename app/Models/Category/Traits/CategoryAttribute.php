 ...
 * @package App\Models\Category\Traits
 */
trait CategoryAttribute
{
    ...
    {
        return '<a href="' . route('admin.category.destroy', $this) . '" class="btn btn-xs btn-danger" data-method="delete"><i class="fa fa-times" data-toggle="tooltip" data-placement="top" title="' . trans('buttons.general.crud.delete') . '"></i></a>';     
    }
